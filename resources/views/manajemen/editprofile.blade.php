                ...
                <div class="col-md-4">
                    <div class="card shadow">
                        <div class="card-body text-center">
                            <img src="{{ Auth::user()->image != null ? asset('storage/user/'.Auth::user()->image) : asset('skydash/images/faces/face21.jpg') }}" alt="{{ Auth::user()->name }}" style="width: 200px; height: 300px; border-radius: 50%;" />
