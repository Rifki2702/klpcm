    ...
    <div class="content-wrapper">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#tambahIsiModal">
                    <i class="fas fa-plus btn-icon-prepend"></i> Tambah Isi Formulir
                </button>
                <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#editNamaFormulirModal">
                    <i class="fas fa-pencil-alt btn-icon-prepend"></i> Edit Nama Formulir
                </button>
                                ...
                                <form method="POST" action="{{ route('admin.insertisi') }}">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button type="submit" class="btn btn-primary">
                                            <i class="fas fa-save btn-icon-prepend"></i> Tambah
                                        </button>
                                    </div>
                                </form>
                            </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <button type="button" class="btn btn-warning btn-sm" data-toggle="modal" data-target="#editModal{{ $isiForm->id }}">
                                            <i class="fas fa-pencil-alt btn-icon-prepend"></i> Edit
                                        </button>
                                        ...
                                        <div class="modal fade" id="editModal{{ $isiForm->id }}" tabindex="-1" role="dialog" aria-labelledby="editModalLabel{{ $isiForm->id }}" aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="{{ route('admin.updateisi', $isiForm->id) }}" method="POST">
                                                            @csrf
                                                            @method('PUT')
                                                            <div class="form-group row">
                                                                <label for="isi" class="col-sm-4 col-form-label text-left">Isi Formulir</label>
                                        ...
                                        <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#deleteModal{{ $isiForm->id }}">
                                            <i class="fas fa-trash btn-icon-prepend"></i> Hapus
                                        </button>
                ...
                <div class="col-4 mt-4">
                    <a href="{{ route('admin.formulirmanagement') }}" class="btn btn-success">
                        Simpan
                    </a>
                </div>
            </div>
