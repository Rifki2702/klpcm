    ...
    <div class="content-wrapper">
        ...
        <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <a href="{{ route('admin.createuser') }}" class="btn btn-primary mb-3"><i class=" fas fa-solid fa-user-plus"></i> Tambah User </a>
                        <div class="row">
                            <div class="col-12">
                                                ...
                                                <td>
                                                    <div class="action-buttons btn-toolbar d-flex justify-content-center" role="toolbar" aria-label="Toolbar with button groups">
                                                        <div class="btn-group" role="group" aria-label="First group">
                                                            <a href="{{ route('admin.edituser',['id' => $d->id]) }}" class="btn btn-warning btn-icon-text">
                                                                <i class="ti-pencil-alt btn-icon-prepend"></i> Edit
                                                            </a>
                                                        </div>
                                                        <div class="btn-group" role="group" aria-label="Second group">
                                                            <form action="{{ route('admin.deleteuser', ['id' => $d->id]) }}" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus {{ $d->name }}?');">
                                                                @csrf
                                                                @method('DELETE')
