                                                                ...
                                                                <div class="col d-flex justify-content-center">
                                                                    <div class="form-check form-check-inline">
                                                                        <label class="form-check-label" for="lengkap{{ $isiForm->id }}">
                                                                            <input type="radio" class="form-check-input" name="kuantitatif[{{ $isiForm->id }}]" id="lengkap{{ $isiForm->id }}" value="1" {{ old('kuantitatif.'.$isiForm->id, isset($isiForm->kelengkapan) && $isiForm->kelengkapan->kuantitatif ? '1' : '') == '1' ? 'checked' : '' }}>
                                                                            Lengkap
                                                                        </label>
                                                                    </div>
                                                                    <div class="form-check form-check-inline">
                                                                        <label class="form-check-label" for="tidaklengkap{{ $isiForm->id }}">
                                                                            <input type="radio" class="form-check-input" name="kuantitatif[{{ $isiForm->id }}]" id="tidaklengkap{{ $isiForm->id }}" value="0" {{ old('kuantitatif.'.$isiForm->id, isset($isiForm->kelengkapan) && !$isiForm->kelengkapan->kuantitatif ? '0' : '') == '0' ? 'checked' : '' }}>
                                                                            Tidak Lengkap
                                                                        </label>
                                                                    </div>
                                                                </div>
